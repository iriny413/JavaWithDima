...
public class ArrayListLesson {
    ...
    public static void arrayListMethods() {
        ...
        System.out.println("sheepList2 size: " + sheepList2 + " " + sheepList2.size());

        sheepList2.set(3, "301");
        sheepList2.set(4, "302");
        sheepList2.set(5, "303");
        sheepList2.set(6, "304");
        sheepList2.set(7, "305");
        System.out.println("sheepList2 size: " + sheepList2 + " " + sheepList2.size());
    }
}
